...
export default function ScreenerPage() {
  ...
  const parseFilters = (): ScreenerFilters => {
    ...
    if (exchangesParam) {
      ...
      filters.exchanges = exchangesParam
        .split(",")
        .map((e) => e.trim()) as Exchange[];
    }

    // Parse sort
    const sortBy = searchParams.get("sortBy");
    if (sortBy) {
      filters.sortBy = sortBy as
        | "volume"
        | "price"
        | "priceChange"
        | "volatility";
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8 text-[#9fa9bc]">
        <p>
          Discover trading opportunities across multiple exchanges. Filter by
          volume, price, and more to find the perfect assets for your strategy.
        </p>
      </div>
